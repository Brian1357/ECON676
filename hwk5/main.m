...
date_annual = xlsread('Problem_Set5.xlsx','Date_annual');
...
BEME25.size(8:end,:) = Mom25.size(7:end-1,:);
BEME25.size(7,:) = nan;
...
for i = 1:5
    ...
    mean_FFF(i) = result.Coefficients.Estimate(1)+result.Coefficients.Estimate(2);
end

%part b
%run the regressions of returns on the the dummy variable
mean_BEME_ext = zeros(1,4);
r_BEME_ext = r_BEME_ext-r_FFF(:,4);
for i = 1:4
    result = fitlm(r_FFF(:,6),r_BEME_ext(:,i));
    mean_BEME_ext(i) = result.Coefficients.Estimate(1)+result.Coefficients.Estimate(2);
end

mean_Mom_ext = zeros(1,4);
r_BEME_ext = r_BEME_ext-r_FFF(:,4);
for i = 1:4
    result = fitlm(r_FFF(:,6),r_BEME_ext(:,i));
    mean_BEME_ext(i) = result.Coefficients.Estimate(1)+result.Coefficients.Estimate(2);
...
%part c
   ...
   for i = 1:25
       betas_BEME(:,i) = regress(BEME25.ret(:,i),[intercept,r_FFF(:,1:3)]);
   end
   ...
   %part 2
      ...
      intercept = ones(25,1);
      for i = 1:1085
          gamma_BEME.r1(i,:) = (regress(BEME25.ret(i,:)',[intercept,betas_BEME(1,:)',BEME25.size(i,:)',BEME25.BEME(i,:)']))';
      end
      ...
      intercept = ones(25,1);
      for i = 1:1085
          gamma_BEME.r2(i,:) = (regress(BEME25.ret(i,:)',[intercept,betas_BEME']))';
      end
      ...
      intercept = ones(25,1);
      for i = 1:1085
          gamma_BEME.r3(i,:) = (regress(BEME25.ret(i,:)',[intercept,betas_BEME(1,:)',BEME25.size(i,:)',BEME25.BEME(i,:)',betas_BEME(2:3,:)']))';
      end
   ...
   %mean
   gamma_BEME.avg1(1,:) = mean(gamma_BEME.r1);
   gamma_BEME.avg2(1,:) = mean(gamma_BEME.r2);
   gamma_BEME.avg3(1,:) = mean(gamma_BEME.r3);
   %standard deviation
   gamma_BEME.avg1(2,:) = std(gamma_BEME.r1)/sqrt(1085);
   gamma_BEME.avg2(2,:) = std(gamma_BEME.r2)/sqrt(1085);
   gamma_BEME.avg3(2,:) = std(gamma_BEME.r3)/sqrt(1085);
   %t-stat
...
index = find(date(:,1) == 1963 & date(:,2) == 1);
   ...
   for i = 1:25
       betas_BEME_e(:,i) = regress(BEME25.ret(index:end,i),[intercept,r_FFF(index:end,1:3)]);
   end
   ...
   %part 2
      ...
      for i = 1:1085-index+1
          gamma_BEME_e.r1(i,:) = (regress(BEME25.ret(index-1+i,:)',[intercept,betas_BEME_e(1,:)',BEME25.size(i,:)',BEME25.BEME(i,:)']))';
      end
      ...
      intercept = ones(25,1);
      for i = 1:1085-index+1
          gamma_BEME_e.r2(i,:) = (regress(BEME25.ret(index-1+i,:)',[intercept,betas_BEME_e']))';
      end
      ...
      intercept = ones(25,1);
      for i = 1:1085-index+1
          gamma_BEME_e.r3(i,:) = (regress(BEME25.ret(index-1+i,:)',[intercept,betas_BEME_e(1,:)',BEME25.size(i,:)',BEME25.BEME(i,:)',betas_BEME_e(2:3,:)']))';
      end
   ...
   %mean
   gamma_BEME_e.avg1(1,:) = mean(gamma_BEME_e.r1);
   gamma_BEME_e.avg2(1,:) = mean(gamma_BEME_e.r2);
   gamma_BEME_e.avg3(1,:) = mean(gamma_BEME_e.r3);
   %standard deviation
   gamma_BEME_e.avg1(2,:) = std(gamma_BEME_e.r1)/sqrt(1085);
   gamma_BEME_e.avg2(2,:) = std(gamma_BEME_e.r2)/sqrt(1085);
   gamma_BEME_e.avg3(2,:) = std(gamma_BEME_e.r3)/sqrt(1085);
   %t-stat
...
%part f
   ...
   intercept = ones(1085,1);
   for i = 1:25
       betas_Mom(:,i) = regress(Mom25.ret(:,i),[intercept,r_FFF(:,1:2),r_FFF(:,5)]);
   end
   ...
   %part 2
      ...
      intercept = ones(25,1);
      for i = 1:1085
          gamma_Mom.r1(i,:) = (regress(Mom25.ret(i,:)',[intercept,betas_Mom(1,:)',Mom25.size(i,:)',Mom25.pastret(i,:)']))';
      end
      ...
      intercept = ones(25,1);
      for i = 1:1085
          gamma_Mom.r2(i,:) = (regress(Mom25.ret(i,:)',[intercept,betas_Mom']))';
      end
      ...
      intercept = ones(25,1);
      for i = 1:1085
          gamma_Mom.r3(i,:) = (regress(Mom25.ret(i,:)',[intercept,betas_Mom(1,:)',Mom25.size(i,:)',Mom25.pastret(i,:)',betas_Mom(2:3,:)']))';
      end
...
index = find(date(:,1) == 1963 & date(:,2) == 1);
   ...
   intercept = ones(1085-index+1,1);
   for i = 1:25
       betas_Mom_h(:,i) = regress(Mom25.ret(index:end,i),[intercept,r_FFF(index:end,1:2),r_FFF(index:end,5)]);
   end
   ...
   %part 2
      ...
      intercept = ones(25,1);
      for i = 1:1085-index+1
          gamma_Mom_h.r1(i,:) = (regress(Mom25.ret(index-1+i,:)',[intercept,betas_Mom_h(1,:)',Mom25.size(index-1+i,:)',Mom25.pastret(index-1+i,:)']))';
      end
      ...
      intercept = ones(25,1);
      for i = 1:1085-index+1
          gamma_Mom_h.r2(i,:) = (regress(Mom25.ret(index-1+i,:)',[intercept,betas_Mom_h']))';
      end
      ...
      intercept = ones(25,1);
      for i = 1:1085-index+1
          gamma_Mom_h.r3(i,:) = (regress(Mom25.ret(index-1+i,:)',[intercept,betas_Mom_h(1,:)',Mom25.size(index-1+i,:)',Mom25.pastret(index-1+i,:)',betas_Mom_h(2:3,:)']))';
      end
   ...
   %standard deviation
   gamma_Mom_h.avg1(2,:) = nanstd(gamma_Mom_h.r1)/sqrt(length(1085-index+1));
   gamma_Mom_h.avg2(2,:) = nanstd(gamma_Mom_h.r2)/sqrt(1085-index+1);
   gamma_Mom_h.avg3(2,:) = nanstd(gamma_Mom_h.r3)/sqrt(1085-index+1);
   %t-stat
